...
public class RentalInformationPage {
    ...
    //Заполнение поля Комментарий курьеру
    ...
    //Ожидание загрузки страницы с дополнительной информацией по заказу

    public void waitForLoadAddRentalInformation() {
        new WebDriverWait(driver, 5)
                .until(ExpectedConditions.elementToBeClickable(dateField));
    }


    //Заполнение страницы с дополнительной информацией по аренде самоката
